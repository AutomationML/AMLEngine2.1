...
**C#**<br />
``` C#
public static IEnumerable<ValidationElement> ClassPathValidationResults(
...
``` VB
<ExtensionAttribute>
Public Shared Function ClassPathValidationResults ( 
...
public:
[ExtensionAttribute]
static IEnumerable<ValidationElement^>^ ClassPathValidationResults(
...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_parent" rel="noopener noreferrer">IEnumerable</a>(<a href="T_Aml_Engine_Services_ValidationElement">ValidationElement</a>)<br />All validation results, which are related to the CAEXPath of a CAEX class.

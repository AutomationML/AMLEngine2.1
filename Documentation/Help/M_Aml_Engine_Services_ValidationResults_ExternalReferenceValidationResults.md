# ValidationResults.ExternalReferenceValidationResults Method 
AutomationML 2.1 API 

Gets the File reference validation results from the validation result list.
...
``` VB
<ExtensionAttribute>
Public Shared Function ExternalReferenceValidationResults ( 
...
public:
[ExtensionAttribute]
static IEnumerable<ValidationElement^>^ ExternalReferenceValidationResults(

...
**VB**<br />
``` VB
Public Class CAEXLibrary(Of TLibItem As CAEXObject)
	Inherits CAEXObject
	Implements ISplitPoint, ICAEXWrapper, IXMLWrapper, IMultipleOccurrences(Of CAEXLibrary(Of TLibItem)), 
	ICAEXBasicObject, IEnumerable(Of TLibItem), IEnumerable
```

**C++**<br />
``` C++
generic<typename TLibItem>
where TLibItem : CAEXObject
public ref class CAEXLibrary : public CAEXObject, 
	ISplitPoint, ICAEXWrapper, IXMLWrapper, IMultipleOccurrences<CAEXLibrary<TLibItem>^>, 
	ICAEXBasicObject, IEnumerable<TLibItem>, IEnumerable
```
...
#### Type Parameters
&nbsp;<dl><dt>TLibItem</dt><dd /></dl>&nbsp;
The CAEXLibrary(TLibItem) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_CAEXLibrary_1__ctor">CAEXLibrary(TLibItem)</a></td><td>
Initializes a new instance of the CAEXLibrary(TLibItem) class.</td></tr></table>&nbsp;
<a href="#caexlibrary(*tlibitem*)-class">Back to Top</a>
...
#### Reference
<a href="N_Aml_Engine_CAEX">Aml.Engine.CAEX Namespace</a><br /><a href="T_Aml_Engine_CAEX_CAEXObject">Aml.Engine.CAEX.CAEXObject</a><br /><a href="T_Aml_Engine_Services_Interfaces_ISplitPoint">Aml.Engine.Services.Interfaces.ISplitPoint</a><br /><a href="T_Aml_Engine_CAEX_IMultipleOccurrences_1">Aml.Engine.CAEX.IMultipleOccurrences(T)</a><br /><a href="T_Aml_Engine_CAEX_CAEXObject">Aml.Engine.CAEX.CAEXObject</a><br /><a href="https://docs.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_parent" rel="noopener noreferrer">System.Collections.Generic.IEnumerable(T)</a><br />

## Inheritance Hierarchy<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_parent" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_CAEXWrapper">Aml.Engine.CAEX.CAEXWrapper</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_CAEXBasicObject">Aml.Engine.CAEX.CAEXBasicObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_CAEXObject">Aml.Engine.CAEX.CAEXObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aml.Engine.CAEX.CAEXLibrary(TLibItem)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Aml_Engine_AmlObjects_AMLLibraryType_1">Aml.Engine.AmlObjects.AMLLibraryType(T)</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_AttributeTypeLibType">Aml.Engine.CAEX.AttributeTypeLibType</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_InstanceHierarchyType">Aml.Engine.CAEX.InstanceHierarchyType</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_InterfaceClassLibType">Aml.Engine.CAEX.InterfaceClassLibType</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_RoleClassLibType">Aml.Engine.CAEX.RoleClassLibType</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_SystemUnitClassLibType">Aml.Engine.CAEX.SystemUnitClassLibType</a><br />
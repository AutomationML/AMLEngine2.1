...
Public Class AttributeSequence
	Inherits CAEXSequenceOfCAEXObjects(Of AttributeType)
```

**C++**<br />
``` C++
public ref class AttributeSequence : public CAEXSequenceOfCAEXObjects<AttributeType^>
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_AttributeSequence__ctor">AttributeSequence</a></td><td>
Initializes a new instance of the AttributeSequence class.</td></tr></table>&nbsp;
<a href="#attributesequence-class">Back to Top</a>

...
Public Interface IMirror
	Inherits ICAEXObject, ICAEXBasicObject, ICAEXWrapper, IXMLWrapper
```

**C++**<br />
``` C++
public interface class IMirror : ICAEXObject, 
	ICAEXBasicObject, ICAEXWrapper, IXMLWrapper
```
...
Gets or sets the identifier.
 (Inherited from <a href="T_Aml_Engine_CAEX_ICAEXObject">ICAEXObject</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_IMirror_IsMaster">IsMaster</a></td><td>
Gets a value indicating whether this instance is a master.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_IMirror_IsMirror">IsMirror</a></td><td>
Gets a value indicating whether this instance is mirror.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_IMirror_Master">Master</a></td><td>
Gets the master.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_IMirror_MasterID">MasterID</a></td><td>
Gets the master identifier.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_ICAEXObject_Name">Name</a></td><td>
...
<a href="#imirror-interface">Back to Top</a>
...
Gets the CAEXSequence for elements of type T, which is owned by this CAEX object.
 (Inherited from <a href="T_Aml_Engine_CAEX_ICAEXBasicObject">ICAEXBasicObject</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_IMirror_CreateMirror">CreateMirror</a></td><td>
Creates a mirror.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_ICAEXBasicObject_Insert_1">Insert(Int32, CAEXWrapper)</a></td><td>
...
#### Reference
<a href="N_Aml_Engine_CAEX">Aml.Engine.CAEX Namespace</a><br /><a href="T_Aml_Engine_CAEX_ICAEXObject">Aml.Engine.CAEX.ICAEXObject</a><br />
# IClassWithBaseClassReference(*T*) Properties
AutomationML 2.1 API 

The <a href="T_Aml_Engine_CAEX_IClassWithBaseClassReference_1">IClassWithBaseClassReference(T)</a> generic type exposes the following members.
...
<a href="#iclasswithbaseclassreference(*t*)-properties">Back to Top</a>

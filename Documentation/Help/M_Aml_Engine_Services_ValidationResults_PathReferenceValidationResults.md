...
``` VB
<ExtensionAttribute>
Public Shared Function PathReferenceValidationResults ( 
...
public:
[ExtensionAttribute]
static IEnumerable<ValidationElement^>^ PathReferenceValidationResults(

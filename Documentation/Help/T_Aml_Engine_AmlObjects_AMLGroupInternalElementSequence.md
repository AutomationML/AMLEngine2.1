...
**VB**<br />
``` VB
Public Class AMLGroupInternalElementSequence
	Inherits InternalElementSequence
```

**C++**<br />
``` C++
public ref class AMLGroupInternalElementSequence : public InternalElementSequence
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_AmlObjects_AMLGroupInternalElementSequence__ctor">AMLGroupInternalElementSequence</a></td><td>
Initializes a new instance of the AMLGroupInternalElementSequence class.</td></tr></table>&nbsp;
<a href="#amlgroupinternalelementsequence-class">Back to Top</a>
...
#### Reference
<a href="N_Aml_Engine_AmlObjects">Aml.Engine.AmlObjects Namespace</a><br /><a href="T_Aml_Engine_CAEX_InternalElementSequence">Aml.Engine.CAEX.InternalElementSequence</a><br />
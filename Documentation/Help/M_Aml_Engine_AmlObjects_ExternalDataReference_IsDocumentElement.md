...
**C#**<br />
``` C#
public static bool IsDocumentElement(
...
``` VB
<ExtensionAttribute>
Public Shared Function IsDocumentElement ( 
...
#### Parameters
&nbsp;<dl><dt>documentElement</dt><dd>Type: <a href="T_Aml_Engine_CAEX_InternalElementType">Aml.Engine.CAEX.InternalElementType</a><br />The internal element.</dd></dl>

#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.boolean" target="_parent" rel="noopener noreferrer">Boolean</a><br />`true` if [is document element] [the specified internal element]; otherwise, `false`.

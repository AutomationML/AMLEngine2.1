# ValidationResults.IDValidationResults Method 
...
``` VB
<ExtensionAttribute>
Public Shared Function IDValidationResults ( 
...
public:
[ExtensionAttribute]
static IEnumerable<ValidationElement^>^ IDValidationResults(
...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_parent" rel="noopener noreferrer">IEnumerable</a>(<a href="T_Aml_Engine_Services_ValidationElement">ValidationElement</a>)<br />All validation results, which are related to the CAEX object ID attribute.

...
**VB**<br />
``` VB
Public Class InstanceHierarchyType
	Inherits CAEXLibrary(Of InternalElementType)
	Implements IInternalElementContainer, ICAEXObject, ICAEXBasicObject, ICAEXWrapper, 
	IXMLWrapper, IEnumerable(Of InternalElementType), IEnumerable
```

**C++**<br />
``` C++
public ref class InstanceHierarchyType : public CAEXLibrary<InternalElementType^>, 
	IInternalElementContainer, ICAEXObject, ICAEXBasicObject, ICAEXWrapper, IXMLWrapper, 
	IEnumerable<InternalElementType^>, IEnumerable
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_InstanceHierarchyType__ctor">InstanceHierarchyType</a></td><td>
Initializes a new instance of the InstanceHierarchyType class.</td></tr></table>&nbsp;
<a href="#instancehierarchytype-class">Back to Top</a>
...
Gets and sets the change mode for a CAEX element (Optional in CAEX).
 (Inherited from <a href="T_Aml_Engine_CAEX_CAEXBasicObject">CAEXBasicObject</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")![Static member](media/static.gif "Static member")</td><td><a href="P_Aml_Engine_CAEX_InstanceHierarchyType_Constructor">Constructor</a></td><td>
The constructor function for the InstanceHierarchyType.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_CAEXBasicObject_Copyright">Copyright</a></td><td>
...
Gets and sets a unique identifier of the CAEX object (optional in CAEX). AutomationML requires IDs for some Elements. These IDs are automatically set when such elements are created.
 (Inherited from <a href="T_Aml_Engine_CAEX_CAEXObject">CAEXObject</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_InstanceHierarchyType_InternalElement">InternalElement</a></td><td>
Gets the List of wrappers for the InternalElements of the top level of the InstanceHierarchy.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_CAEXObject_Name">Name</a></td><td>
...
#### Reference
<a href="N_Aml_Engine_CAEX">Aml.Engine.CAEX Namespace</a><br /><a href="T_Aml_Engine_CAEX_CAEXLibrary_1">Aml.Engine.CAEX.CAEXLibrary(TLibItem)</a><br /><a href="T_Aml_Engine_CAEX_IInternalElementContainer">Aml.Engine.CAEX.IInternalElementContainer</a><br />
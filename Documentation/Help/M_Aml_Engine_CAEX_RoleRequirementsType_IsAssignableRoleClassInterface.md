...
**VB**<br />
``` VB
Public Function IsAssignableRoleClassInterface ( 
...
``` C++
public:
bool IsAssignableRoleClassInterface(
	ExternalInterfaceType^ externalInterface
)
```
...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.boolean" target="_parent" rel="noopener noreferrer">Boolean</a><br />`true` if the ExternalInterface object is an assignable role class interface; otherwise, `false`.

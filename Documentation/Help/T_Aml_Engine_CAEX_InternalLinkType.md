...
Public Class InternalLinkType
	Inherits CAEXObject
	Implements IMultipleOccurrences(Of InternalLinkType), ICAEXBasicObject, 
	ICAEXWrapper, IXMLWrapper
```

**C++**<br />
``` C++
public ref class InternalLinkType : public CAEXObject, 
	IMultipleOccurrences<InternalLinkType^>, ICAEXBasicObject, ICAEXWrapper, IXMLWrapper
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_InternalLinkType__ctor">InternalLinkType</a></td><td>
Initializes a new instance of the InternalLinkType class.</td></tr></table>&nbsp;
<a href="#internallinktype-class">Back to Top</a>
...
Gets the collection of AdditionalInformation values contained in this instance.
 (Inherited from <a href="T_Aml_Engine_CAEX_CAEXBasicObject">CAEXBasicObject</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_InternalLinkType_AInterface">AInterface</a></td><td>
Gets and sets the AInterface of the InternalLink by reading or setting the <a href="P_Aml_Engine_CAEX_InternalLinkType_RefPartnerSideA">RefPartnerSideA</a> Attribute. A read access to this property updates the <a href="P_Aml_Engine_CAEX_InternalLinkType_RelatedObjects">RelatedObjects</a>.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_InternalLinkType_ASystemUnitClass">ASystemUnitClass</a></td><td>
Gets the SystemUnitClass associated to the <a href="P_Aml_Engine_CAEX_InternalLinkType_AInterface">AInterface</a>.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_InternalLinkType_BInterface">BInterface</a></td><td>
Gets and sets the BInterface of the InternalLink by reading or setting the <a href="P_Aml_Engine_CAEX_InternalLinkType_RefPartnerSideB">RefPartnerSideB</a> Attribute. A read access to this property updates the <a href="P_Aml_Engine_CAEX_InternalLinkType_RelatedObjects">RelatedObjects</a>.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_InternalLinkType_BSystemUnitClass">BSystemUnitClass</a></td><td>
Gets the SystemUnitClass associated to the <a href="P_Aml_Engine_CAEX_InternalLinkType_BInterface">BInterface</a>.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_CAEXWrapper_CAEXDocument">CAEXDocument</a></td><td>
...
Gets and sets a unique identifier of the CAEX object (optional in CAEX). AutomationML requires IDs for some Elements. These IDs are automatically set when such elements are created.
 (Inherited from <a href="T_Aml_Engine_CAEX_CAEXObject">CAEXObject</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_InternalLinkType_IsDefined">IsDefined</a></td><td>
Determines, if this InternalLink Instance has defined Interfaces.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_CAEXObject_Name">Name</a></td><td>
...
Gets the wrapped Xml-Element's parent
 (Inherited from <a href="T_Aml_Engine_CAEX_CAEXWrapper">CAEXWrapper</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_InternalLinkType_RefPartnerSideA">RefPartnerSideA</a></td><td>
Gets and sets the Path to an ExternalInterface, defining the A-Side of the relation.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_InternalLinkType_RefPartnerSideB">RefPartnerSideB</a></td><td>
Gets and sets the Path to an ExternalInterface, defining the B-Side of the relation.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_InternalLinkType_RelatedObjects">RelatedObjects</a></td><td>
...
A direct access to one of the listed properties results in a recalculation of the accessed property.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_CAEXBasicObject_Revision">Revision</a></td><td>
...
Inserts the specified CAEX object in it's associated sequence. The CAEXBasicObject defines the <a href="P_Aml_Engine_CAEX_CAEXBasicObject_Revision">Revision</a> and <a href="P_Aml_Engine_CAEX_CAEXBasicObject_SourceObjectInformation">SourceObjectInformation</a> sequences.
 (Inherited from <a href="T_Aml_Engine_CAEX_CAEXBasicObject">CAEXBasicObject</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_InternalLinkType_InsertAfter">InsertAfter</a></td><td>
Inserts the provided CAEX object as a new sibling after this CAEX object.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_InternalLinkType_InsertBefore">InsertBefore</a></td><td>
...
This method can be used to create an XML node, if this CAEX wrapper was instantiated without an XML node. This method can only be applied, if an <a href="P_Aml_Engine_CAEX_CAEXWrapper_Owner">Owner</a> is defined. The new created CAEX object is inserted as a new child of the owner.
 (Inherited from <a href="T_Aml_Engine_CAEX_CAEXWrapper">CAEXWrapper</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_InternalLinkType_InterfaceFromAttributeValue">InterfaceFromAttributeValue</a></td><td>
Gets the Interface from the provided InternalLink Attribute value, which is from <a href="P_Aml_Engine_CAEX_InternalLinkType_RefPartnerSideA">RefPartnerSideA</a> or from the <a href="P_Aml_Engine_CAEX_InternalLinkType_RefPartnerSideB">RefPartnerSideB</a> attribute.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")</td><td><a href="M_Aml_Engine_CAEX_InternalLinkType_New_InternalLink">New_InternalLink</a></td><td>
Creates a new InternalLink object and append it to the lowest common parent of the SystemUnitClass objects, associated with the provided ExternalInterface objects. If no common parent exists, the InternalLink will be associated with the owner of the *aInterface*.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_CAEXBasicObject_New_Revision">New_Revision</a></td><td>

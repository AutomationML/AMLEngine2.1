...
**C#**<br />
``` C#
public RoleFamilyType Product { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property Product As RoleFamilyType
	Get
```
...
``` C++
public:
property RoleFamilyType^ Product {
	RoleFamilyType^ get ();
}
```
...
#### Property Value
Type: <a href="T_Aml_Engine_CAEX_RoleFamilyType">RoleFamilyType</a><br />The product.

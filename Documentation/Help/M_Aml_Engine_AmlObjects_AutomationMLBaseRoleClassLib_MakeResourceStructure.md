# AutomationMLBaseRoleClassLib.MakeResourceStructure Method 
...
**C#**<br />
``` C#
public static void MakeResourceStructure(
...
``` VB
<ExtensionAttribute>
Public Shared Sub MakeResourceStructure ( 
...
public:
[ExtensionAttribute]
static void MakeResourceStructure(

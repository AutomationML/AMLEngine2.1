...
Extension methods for the <a href="T_Aml_Engine_CAEX_SystemUnitClassType">SystemUnitClassType</a>.


## Inheritance Hierarchy
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_parent" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Aml.Engine.CAEX.Extensions.SystemUnitClassTypeExtensions<br />
...
``` VB
<ExtensionAttribute>
Public NotInheritable Class SystemUnitClassTypeExtensions
```

**C++**<br />
``` C++
[ExtensionAttribute]
public ref class SystemUnitClassTypeExtensions abstract sealed
```
...
<a href="#systemunitclasstypeextensions-class">Back to Top</a>

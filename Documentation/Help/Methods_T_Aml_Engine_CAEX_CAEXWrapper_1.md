# CAEXWrapper(*TDataType*) Methods
AutomationML 2.1 API 

The <a href="T_Aml_Engine_CAEX_CAEXWrapper_1">CAEXWrapper(TDataType)</a> generic type exposes the following members.
...
<a href="#caexwrapper(*tdatatype*)-methods">Back to Top</a>

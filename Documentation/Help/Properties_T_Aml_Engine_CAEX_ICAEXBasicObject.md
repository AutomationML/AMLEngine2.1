# ICAEXBasicObject Properties
AutomationML 2.1 API 

The <a href="T_Aml_Engine_CAEX_ICAEXBasicObject">ICAEXBasicObject</a> type exposes the following members.
...
<a href="#icaexbasicobject-properties">Back to Top</a>

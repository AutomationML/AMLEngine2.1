# ValidationResults.MetaDataValidationResults Method 
...
**C#**<br />
``` C#
public static IEnumerable<ValidationElement> MetaDataValidationResults(
...
``` VB
<ExtensionAttribute>
Public Shared Function MetaDataValidationResults ( 
...
public:
[ExtensionAttribute]
static IEnumerable<ValidationElement^>^ MetaDataValidationResults(
...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_parent" rel="noopener noreferrer">IEnumerable</a>(<a href="T_Aml_Engine_Services_ValidationElement">ValidationElement</a>)<br />All validation results, which are related to MetaData assigned to a CAEXFile.

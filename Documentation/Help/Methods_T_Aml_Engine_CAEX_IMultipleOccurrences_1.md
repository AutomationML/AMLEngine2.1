# IMultipleOccurrences(*T*) Methods
AutomationML 2.1 API 

The <a href="T_Aml_Engine_CAEX_IMultipleOccurrences_1">IMultipleOccurrences(T)</a> generic type exposes the following members.
...
<a href="#imultipleoccurrences(*t*)-methods">Back to Top</a>

...
**C++**<br />
``` C++
public interface class IInstantiable : ICAEXObject, 
	ICAEXBasicObject, ICAEXWrapper, IXMLWrapper
```
...
<a href="#iinstantiable-interface">Back to Top</a>
...
Gets the CAEXSequence for elements of type T, which is owned by this CAEX object.
 (Inherited from <a href="T_Aml_Engine_CAEX_ICAEXBasicObject">ICAEXBasicObject</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_IInstantiable_CreateClassInstance">CreateClassInstance</a></td><td>

# IMappingElementType Methods
AutomationML 2.1 API 

The <a href="T_Aml_Engine_CAEX_IMappingElementType">IMappingElementType</a> type exposes the following members.
...
<a href="#imappingelementtype-methods">Back to Top</a>

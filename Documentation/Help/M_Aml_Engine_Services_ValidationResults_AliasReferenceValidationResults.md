...
``` VB
<ExtensionAttribute>
Public Shared Function AliasReferenceValidationResults ( 
...
public:
[ExtensionAttribute]
static IEnumerable<ValidationElement^>^ AliasReferenceValidationResults(

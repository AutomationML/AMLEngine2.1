...
**VB**<br />
``` VB
Public Class AttributeNameMappingType
	Inherits MappingElementType(Of AttributeType)
```

**C++**<br />
``` C++
public ref class AttributeNameMappingType : public MappingElementType<AttributeType^>
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_AttributeNameMappingType__ctor">AttributeNameMappingType</a></td><td>
Creates a wrapper for the specified XElement which is an AttributeNameMapping Element</td></tr></table>&nbsp;
<a href="#attributenamemappingtype-class">Back to Top</a>

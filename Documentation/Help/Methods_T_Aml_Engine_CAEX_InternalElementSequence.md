# InternalElementSequence Methods
AutomationML 2.1 API 

The <a href="T_Aml_Engine_CAEX_InternalElementSequence">InternalElementSequence</a> type exposes the following members.
...
<a href="#internalelementsequence-methods">Back to Top</a>

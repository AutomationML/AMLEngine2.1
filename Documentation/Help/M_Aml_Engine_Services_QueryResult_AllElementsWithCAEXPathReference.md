...
**C#**<br />
``` C#
public static ILookup<string, ICAEXReference> AllElementsWithCAEXPathReference(
...
``` VB
<ExtensionAttribute>
Public Shared Function AllElementsWithCAEXPathReference ( 
	doc As CAEXDocument
...
public:
[ExtensionAttribute]
static ILookup<String^, ICAEXReference^>^ AllElementsWithCAEXPathReference(
	CAEXDocument^ doc
)
```

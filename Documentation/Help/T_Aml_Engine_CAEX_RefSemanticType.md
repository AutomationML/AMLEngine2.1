...
This class is a CAEXWrapper for the CAEX element 'RefSemantic' used in an <a href="T_Aml_Engine_CAEX_AttributeType">AttributeType</a>.


## Inheritance Hierarchy
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_parent" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_CAEXWrapper">Aml.Engine.CAEX.CAEXWrapper</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Aml_Engine_CAEX_CAEXBasicObject">Aml.Engine.CAEX.CAEXBasicObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aml.Engine.CAEX.RefSemanticType<br />
...
**VB**<br />
``` VB
Public Class RefSemanticType
	Inherits CAEXBasicObject
```

**C++**<br />
``` C++
public ref class RefSemanticType : public CAEXBasicObject
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Aml_Engine_CAEX_RefSemanticType__ctor">RefSemanticType</a></td><td>
Initializes a new instance of the RefSemanticType class.</td></tr></table>&nbsp;
<a href="#refsemantictype-class">Back to Top</a>
...
Gets the wrapper for the Copyright element.
 (Inherited from <a href="T_Aml_Engine_CAEX_CAEXBasicObject">CAEXBasicObject</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_RefSemanticType_CorrespondingAttributePath">CorrespondingAttributePath</a></td><td>
Gets and sets the Attribute 'CorrespondingAttributePath' of the RefSemantic object.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Aml_Engine_CAEX_CAEXBasicObject_Description">Description</a></td><td>

...
``` VB
<ExtensionAttribute>
Public Shared Function CAEXFile ( 
...
#### Return Value
Type: <a href="T_Aml_Engine_CAEX_CAEXFileType">CAEXFileType</a><br />The CAEX file, containing the CAEX object.

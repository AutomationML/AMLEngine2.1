...
**C#**<br />
``` C#
public static IEnumerable<InternalElementType> AllInternalElementMirrors(
...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1" target="_parent" rel="noopener noreferrer">IEnumerable</a>(<a href="T_Aml_Engine_CAEX_InternalElementType">InternalElementType</a>)<br />An enumeration of all InternalElement mirror objects.

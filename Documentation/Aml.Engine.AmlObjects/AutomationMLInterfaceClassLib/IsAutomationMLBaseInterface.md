AutomationMLInterfaceClassLib.IsAutomationMLBaseInterface Method
================================================================
AutomationML 2.1 APIDetermines whether the specified interface class is derived from the AutomationMLBase interface class. The method can resolve alias references anywhere in the inheritance hierarchy.
...
```csharp
public static bool IsAutomationMLBaseInterface(

AutomationMLInterfaceClassLib.IsOrderInterface Method
=====================================================
AutomationML 2.1 APIDetermines whether the specified interface class is derived from the Order interface class. The method can resolve alias references anywhere in the inheritance hierarchy.
...
```csharp
public static bool IsOrderInterface(

...
=====================================================
AutomationML 2.1 APIGets the ID reference validation results from the validation result list.
...
Type: [IEnumerable][2]&lt;[ValidationElement][3]>  
 All validation results, which are related to CAEX objects which use IDs to reference other CAEX objects. 
#### Usage Note

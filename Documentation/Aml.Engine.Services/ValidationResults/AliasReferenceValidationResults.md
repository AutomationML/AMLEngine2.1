ValidationResults.AliasReferenceValidationResults Method
========================================================
AutomationML 2.1 APIGets the Alias reference validation results from the validation result list.
...
```csharp
public static IEnumerable<ValidationElement> AliasReferenceValidationResults(
...
Type: [IEnumerable][2]&lt;[ValidationElement][3]>  
 All validation results, which are related to CAEX objects which use an Alias to reference CAEX objects in external sources. 
#### Usage Note

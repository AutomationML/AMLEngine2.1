ValidationResults.InvalidAutomationMLVersion Method
===================================================
AutomationML 2.1 APIGets the validation results for all MetaData which are related to the AutomationML Version
...
```csharp
public static IEnumerable<ValidationElement> InvalidAutomationMLVersion(
...
All validation results, which are related to MetaData which are related to the AutomationML Version.
#### Usage Note

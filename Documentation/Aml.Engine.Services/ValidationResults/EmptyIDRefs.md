...
====================================
AutomationML 2.1 APIGets the validation results for all elements with ID references which are empty.
...
All validation results, which are related to ID references which are empty.
#### Usage Note

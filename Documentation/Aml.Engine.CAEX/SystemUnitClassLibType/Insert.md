SystemUnitClassLibType.Insert Method (CAEXWrapper, Boolean)
===========================================================
AutomationML 2.1 APIInserts the specified CAEX object in it's associated sequence. The SystemUnitClassLibType defines the [SystemUnitClass][1] sequence.
...
#### Reference
[SystemUnitClassLibType Class][7]  

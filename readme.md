...
The sample solutions have been updated to the actual .NET version. A new solution has been added that shows how to use the AutomationML Library service using examples. Among other things, you will learn how to check the validity of a signed AutomationML library.
